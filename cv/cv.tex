...
\usepackage[colorlinks, allcolors={purple!75!black}, plainpages=false]{hyperref}
\usepackage[sfdefault]{quattrocento}
\usepackage[style=trad-abbrv, sorting=ddnt]{biblatex}
\usepackage{array, csquotes, ifthen, multirow, parskip, xcolor, pifont}

\IfFileExists{\jobname.bib}{\addbibresource{\jobname.bib}}{}
...
\begin{headertable}
  \headerrow{About \\[1ex] \scriptsize{(rev. \DTMtoday)}}{
    I am an information security consultant with 10+ years of experience and
...
\begin{contenttable}{Education}
  ...
  \contentrow
    ...
    {
      from UFSC (see thesis
      \IfFileExists{\jobname.bib}
        {at \cite{Zambonin:202010}}
        {\href{https://repositorio.ufsc.br/handle/123456789/219497}{here}})
    }
    {Aug/2018}
    {Sep/2020}
    {
  ...
  \contentrow
    {BSc in Computer Science}
    {
      from UFSC (see thesis
      \IfFileExists{\jobname.bib}
        {at \cite{Zambonin:201806}}
        {\href{https://repositorio.ufsc.br/handle/123456789/187875}{here}})
    }
    {Mar/2013}
    {Jul/2018}
    {
